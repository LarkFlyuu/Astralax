...
func.func @relu_to_xsmm(%arg0: memref<5x6xf32>) {
  ...
  astl.relu ins(%arg0: memref<5x6xf32>) outs(%arg0: memref<5x6xf32>)
  return
}
...
func.func @relu_to_xsmm(%arg0: memref<5x6xf32>, %arg1: memref<5x6xf32>) {
  ...
  astl.relu ins(%arg0: memref<5x6xf32>) outs(%arg1: memref<5x6xf32>)
  return
}
...
func.func @relu_to_xsmm(%arg0: memref<1x32xf32>) {
  ...
  astl.relu ins(%arg0: memref<1x32xf32>) outs(%arg0: memref<1x32xf32>)
  return
}
