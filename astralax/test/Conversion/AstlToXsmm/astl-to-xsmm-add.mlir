// RUN: astl-opt %s -convert-astl-to-xsmm -split-input-file | FileCheck %s
...
func.func @add_to_xsmm_1d(%arg0: memref<1x32xf32>, %arg1: memref<1x32xf32>, %arg2: memref<1x32xf32>) {
  ...
  astl.add ins(%arg0: memref<1x32xf32>, %arg1: memref<1x32xf32>) outs(%arg2: memref<1x32xf32>)
  return 
}
...
func.func @add_to_xsmm_2d(%arg0: memref<3x4xf32>, %arg1: memref<3x4xf32>, %arg2: memref<3x4xf32>) {
  ...
  astl.add ins(%arg0: memref<3x4xf32>, %arg1: memref<3x4xf32>) outs(%arg2: memref<3x4xf32>)
  return
}
...
func.func @add_to_xsmm_bcast_on_col(%arg0: memref<1x5xf32>, %arg1: memref<5x5xf32>,
  ...
  astl.add ins(%arg0: memref<1x5xf32>, %arg1: memref<5x5xf32>) outs(%arg1: memref<5x5xf32>)
  // CHECK: %{{.+}} = xsmm.binary.dispatch add [5, 5, 5, 5, 5] flags = (bcast_col_in0) data_type = f32
  astl.add ins(%arg1: memref<5x5xf32>, %arg0: memref<1x5xf32>) outs(%arg1: memref<5x5xf32>)
...
func.func @add_to_xsmm_bcast_on_row(%arg0: memref<5x1xf32>, %arg1: memref<5x5xf32>) {
  astl.add ins(%arg0: memref<5x1xf32>, %arg1: memref<5x5xf32>) outs(%arg1: memref<5x5xf32>)
  // CHECK: %{{.+}} = xsmm.binary.dispatch add [5, 5, 1, 5, 5] flags = (bcast_row_in0) data_type = f32
  astl.add ins(%arg1: memref<5x5xf32>, %arg0: memref<5x1xf32>) outs(%arg1: memref<5x5xf32>)
...
func.func @add_to_xsmm_bcast_on_scalar_or_none(
  ...
  astl.add ins(%arg2: memref<1x5xf32>, %arg1: memref<5xf32>) outs(%arg2: memref<1x5xf32>)
  // CHECK: %{{.+}} = xsmm.binary.dispatch add [1, 5, 5, 5, 5] flags = (none) data_type = f32
  astl.add ins(%arg0: memref<1xf32>, %arg3: memref<5x5xf32>) outs(%arg3: memref<5x5xf32>)
  // CHECK: %{{.+}} = xsmm.binary.dispatch add [5, 5, 1, 5, 5] flags = (bcast_scalar_in0) data_type = f32
  astl.add ins(%arg1: memref<5xf32>, %arg2: memref<1x5xf32>) outs(%arg2: memref<1x5xf32>)
  // CHECK: %{{.+}} = xsmm.binary.dispatch add [1, 5, 5, 5, 5] flags = (none) data_type = f32
  return
} 
