...
func.func @entry(){
  ...
  astl.identity ins(%arg2 : memref<512xbf16>) outs(%arg3 : memref<128x512xbf16>)
  %wt = memref.alloc():memref<128x512x2xbf16>
  linalg.fill ins(%c0:bf16) outs(%wt:memref<128x512x2xbf16>)
  astl.gemm ins(%arg0 : memref<128x256xbf16>, %wt : memref<128x512x2xbf16>, %arg3 : memref<128x512xbf16>) outs(%arg3 : memref<128x512xbf16>)
  astl.relu ins(%arg3 : memref<128x512xbf16>) outs(%arg3 : memref<128x512xbf16>)
