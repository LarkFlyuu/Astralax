// RUN: astl-opt %s -split-input-file -tile-consumer-and-fuse-producers="tile-sizes=5,5 use-for-all=false" -cse | FileCheck %s
// RUN: astl-opt %s -split-input-file -tile-consumer-and-fuse-producers="tile-sizes=0,0 use-for-all=false" -cse | FileCheck %s
// RUN: astl-opt %s -split-input-file -tile-consumer-and-fuse-producers="tile-sizes=5,5,5 use-for-all=false" -cse | FileCheck %s
// RUN: astl-opt %s -split-input-file -tile-consumer-and-fuse-producers="tile-sizes=2,0 use-for-all=false" -cse | FileCheck -check-prefix=TILE %s
