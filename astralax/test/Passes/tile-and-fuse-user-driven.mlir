// RUN: astl-opt %s -split-input-file -tile-consumer-and-fuse-producers="tile-sizes=4,4 use-for-all=false" -cse | FileCheck -check-prefix=CONF1 %s

// RUN: astl-opt %s -split-input-file -tile-consumer-and-fuse-producers="tile-sizes=1,1,1 use-for-all=false" -cse -canonicalize | FileCheck -check-prefix=CONF2 %s
