//RUN: astl-opt %s -astl-combine -split-input-file | FileCheck %s
...
func.func @fused_brgemm_test0(%arg0: tensor<4x32x32xf32>, %arg1: tensor<4x32x32xf32>, %arg2: tensor<32x32xf32>,
  ...
  %0 = astl.brgemm (%arg0: tensor<4x32x32xf32>, %arg1: tensor<4x32x32xf32>, %arg2: tensor<32x32xf32>) -> tensor<32x32xf32>
...
func.func @fused_brgemm_test1(%arg0: tensor<4x32x32xf32>, %arg1: tensor<4x32x32xf32>, %arg2: tensor<32x32xf32>,
                        %arg3: tensor<32x32xf32>) -> tensor<32x32xf32> {
  %0 = astl.brgemm (%arg0: tensor<4x32x32xf32>, %arg1: tensor<4x32x32xf32>, %arg2: tensor<32x32xf32>) -> tensor<32x32xf32>
  %1 = astl.add (%arg3: tensor<32x32xf32>, %0: tensor<32x32xf32>) -> tensor<32x32xf32>
  %2 = astl.relu (%1: tensor<32x32xf32>) -> tensor<32x32xf32>
  return %2 : tensor<32x32xf32>
}
