// RUN: astl-opt %s -default-astl-passes="linalg-to-loops" -split-input-file | FileCheck %s

// Direct linalg lowering to loops should leave all ASTL operations untouched.
// CHECK-NOT: func.func private @xsmm_
// CHECK: func.func @astl_ops(
// CHECK-SAME:  %[[ARG0:[^ ]+]]: memref<3x3xf32>,
// CHECK-SAME:  %[[ARG1:[^ ]+]]: memref<3x3xf32>,
// CHECK-SAME:  %[[ARG2:[^ ]+]]: memref<1x1xf32>)
func.func @astl_ops(%arg0: memref<3x3xf32>, %arg1: memref<3x3xf32>, %arg2: memref<1x1xf32>) {
  // CHECK: astl.identity
  // CHECK: astl.add
  // CHECK: astl.relu
  astl.identity ins(%arg2 : memref<1x1xf32>) outs(%arg0 : memref<3x3xf32>)
