// RUN: astl-opt %s -astl-conversion -split-input-file | FileCheck %s

#map = affine_map<(d0, d1) -> (d0, d1)>

func.func @astl_sequence(%arg0: tensor<3x5x4xf32>, %arg1: tensor<3x4x5xf32>,
...
// CHECK-LABEL: func.func @astl_sequence(
