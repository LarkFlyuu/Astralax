...
// RUN: astl-opt %s -gpu-pipeline=gpu=cuda -split-input-file | FileCheck %s
...
// CHECK: gpu.module @astl_gemm_kernel attributes {gpu.binary = "
// CHECK-LABEL: llvm.func @astl_gemm_kernel
// CHECK-DAG:     nvvm.read
// CHECK-DAG:     llvm.mul
// CHECK-DAG:     llvm.add
