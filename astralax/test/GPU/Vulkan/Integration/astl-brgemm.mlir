...
func.func @entry(%arg0: memref<2x8x32x32xf32>, %arg1: memref<8x8x32x32xf32>, %arg2: memref<2x8x32x32xf32>) {
  ...
  scf.parallel (%arg3, %arg4) = (%c0, %c0) to (%c2, %c8) step (%c1, %c1) {
    ...
    astl.brgemm ins(%subview : memref<8x32x32xf32, strided<[1024, 32, 1], offset: ?>>, %subview_0 : memref<8x32x32xf32, strided<[1024, 32, 1], offset: ?>>, %subview_1 : memref<32x32xf32, strided<[32, 1], offset: ?>>) outs(%subview_1 : memref<32x32xf32, strided<[32, 1], offset: ?>>)
    scf.yield
  }
