// RUN: astl-opt %s -bufferize -split-input-file | FileCheck %s

// CHECK-LABEL: func.func @astl_tensor_add
// CHECK-SAME: %[[ARG0:.+]]: memref<32x32xf32>, %[[ARG1:.+]]: memref<32x32xf32>
func.func @astl_tensor_add(%arg0: tensor<32x32xf32>, %arg1: tensor<32x32xf32>) -> tensor<32x32xf32> {
  %0 = astl.add (%arg0: tensor<32x32xf32>, %arg1: tensor<32x32xf32>) -> tensor<32x32xf32>
  // CHECK: astl.add ins(%[[ARG0]] : memref<32x32xf32>, %[[ARG1]] : memref<32x32xf32>)
...
// CHECK-LABEL: func.func @astl_tensor_add_bufferize_on_rhs
// CHECK-SAME: %[[ARG0:.+]]: memref<32xf32>, %[[ARG1:.+]]: memref<32x32xf32>
func.func @astl_tensor_add_bufferize_on_rhs(%arg0: tensor<32xf32>, %arg1: tensor<32x32xf32>) -> tensor<32x32xf32> {
  %0 = astl.add (%arg0: tensor<32xf32>, %arg1: tensor<32x32xf32>) -> tensor<32x32xf32>
  // CHECK: astl.add ins(%[[ARG0]] : memref<32xf32>, %[[ARG1]] : memref<32x32xf32>) 
  // CHECK-SAME:    outs(%[[ARG1]] : memref<32x32xf32>)
  return %0 : tensor<32x32xf32>
}
...
// CHECK-LABEL: func.func @astl_tensor_add_bufferize_on_lhs
// CHECK-SAME: %[[ARG0:.+]]: memref<32x32xf32>, %[[ARG1:.+]]: memref<32xf32>
func.func @astl_tensor_add_bufferize_on_lhs(%arg0: tensor<32x32xf32>, %arg1: tensor<32xf32>) -> tensor<32x32xf32> {
  %0 = astl.add (%arg0: tensor<32x32xf32>, %arg1: tensor<32xf32>) -> tensor<32x32xf32>
  // CHECK: astl.add ins(%[[ARG0]] : memref<32x32xf32>, %[[ARG1]] : memref<32xf32>) 
...
// CHECK-LABEL: func.func @astl_tensor_add_bufferize_outs_of_place
// CHECK-SAME: %[[ARG0:.+]]: memref<1xf32>, %[[ARG1:.+]]: memref<32xf32>
func.func @astl_tensor_add_bufferize_outs_of_place(%arg0: tensor<1xf32>, %arg1: tensor<32xf32>) -> tensor<32x32xf32> {
  %0 = astl.add (%arg0: tensor<1xf32>, %arg1: tensor<32xf32>) -> tensor<32x32xf32>
  // CHECK: %[[ALLOC:.+]] = memref.alloc() {alignment = 64 : i64} : memref<32x32xf32>
  // CHECK-NEXT: astl.add ins(%[[ARG0]] : memref<1xf32>, %[[ARG1]] : memref<32xf32>) 
...
// CHECK-LABEL: func.func @astl_tensor_add_loop
// CHECK-SAME: %[[ARG0:.+]]: memref<32x32xf32>, %[[ARG1:.+]]: memref<32x32xf32>
func.func @astl_tensor_add_loop(%arg0: tensor<32x32xf32>, %arg1: tensor<32x32xf32>) -> tensor<32x32xf32> {
  ...
  %r = scf.for %i = %c0 to %c10 step %c1 iter_args(%iter_arg1 = %arg1) -> tensor<32x32xf32> {
    %added = astl.add (%arg0: tensor<32x32xf32>, %iter_arg1: tensor<32x32xf32>) -> tensor<32x32xf32>
    scf.yield %added : tensor<32x32xf32>
  }
  // CHECK: scf.for %[[I:.+]] = %[[C0]] to %[[C10]] step %[[C1]] {
  // CHECK-NEXT: astl.add ins(%[[ARG0]] : memref<32x32xf32>, %[[ARG1]] : memref<32x32xf32>) 
  // CHECK-SAME:         outs(%[[ARG1]] : memref<32x32xf32>)
...
// CHECK-LABEL: func.func @astl_tensor_relu
// CHECK-SAME:  %[[ARG0:.+]]: memref<32x32xf32>
func.func @astl_tensor_relu(%arg0: tensor<32x32xf32>) -> tensor<32x32xf32> {
  // CHECK: astl.relu ins(%[[ARG0]] : memref<32x32xf32>) outs(%[[ARG0]] : memref<32x32xf32>)
  %0 = astl.relu (%arg0: tensor<32x32xf32>) -> tensor<32x32xf32>
  return %0 : tensor<32x32xf32>
}

// -----

// CHECK-LABEL: func.func @astl_tensor_relu_must_allocate
// CHECK-SAME: (%[[ARG0:.+]]: memref<32xf32>) -> memref<32x32xf32>
func.func @astl_tensor_relu_must_allocate(%arg0: tensor<32xf32>) -> tensor<32x32xf32> {
  // CHECK: %[[ALLOC:.+]] = memref.alloc() {alignment = 64 : i64} : memref<32x32xf32>
  // CHECK-NEXT: astl.relu ins(%[[ARG0]] : memref<32xf32>) outs(%[[ALLOC]] : memref<32x32xf32>)
  // CHECK-NEXT: return %[[ALLOC]] : memref<32x32xf32>
  %0 = astl.relu (%arg0: tensor<32xf32>) -> tensor<32x32xf32>
  return %0 : tensor<32x32xf32>
}
...
func.func @relu_tensor_loop(%arg0: tensor<32x32xf32>) -> tensor<32x32xf32> {
  ...
  %r = scf.for %i = %c0 to %c10 step %c1 iter_args(%iter_arg0 = %arg0) -> tensor<32x32xf32> {
    %relu = astl.relu (%iter_arg0: tensor<32x32xf32>) -> tensor<32x32xf32>
    scf.yield %relu : tensor<32x32xf32>
  }
  // CHECK: scf.for %[[I:.+]] = %[[C0]] to %[[C10]] step %[[C1]]
  // CHECK-NEXT: astl.relu ins(%[[ARG0]] : memref<32x32xf32>) outs(%[[ARG0]] : memref<32x32xf32>)
  return %r : tensor<32x32xf32>
}

// -----

// CHECK-LABEL: func.func @astl_tensor_identity
// CHECK-SAME:  %[[ARG0:.+]]: memref<32x32xf32>
func.func @astl_tensor_identity(%arg0: tensor<32x32xf32>) -> tensor<32x32xf32> {
  // CHECK: astl.identity ins(%[[ARG0]] : memref<32x32xf32>) outs(%[[ARG0]] : memref<32x32xf32>)
  %0 = astl.identity (%arg0: tensor<32x32xf32>) -> tensor<32x32xf32>
  return %0 : tensor<32x32xf32>
}

// -----

// CHECK-LABEL: func.func @astl_tensor_identity_must_allocate
// CHECK-SAME: (%[[ARG0:.+]]: memref<32xf32>) -> memref<32x32xf32>
func.func @astl_tensor_identity_must_allocate(%arg0: tensor<32xf32>) -> tensor<32x32xf32> {
  // CHECK: %[[ALLOC:.+]] = memref.alloc() {alignment = 64 : i64} : memref<32x32xf32>
  // CHECK-NEXT: astl.identity ins(%[[ARG0]] : memref<32xf32>) outs(%[[ALLOC]] : memref<32x32xf32>)
  // CHECK-NEXT: return %[[ALLOC]] : memref<32x32xf32>
...
// CHECK-LABEL: func.func @astl_tensor_gemm
// CHECK-SAME:  %[[ARG0:.+]]: memref<32x64xf32>, %[[ARG1:.+]]: memref<64x32xf32>, 
// CHECK-SAME:  %[[ARG2:.+]]: memref<32x32xf32>
func.func @astl_tensor_gemm(%arg0: tensor<32x64xf32>, %arg1: tensor<64x32xf32>,
                             %arg2: tensor<32x32xf32>) -> tensor<32x32xf32> {
  // CHECK: astl.gemm ins(%[[ARG0]] : memref<32x64xf32>, %[[ARG1]] : memref<64x32xf32>, %[[ARG2]] : memref<32x32xf32>)
  // CHECK-SAME:     outs(%[[ARG2]] : memref<32x32xf32>)
  %0 = astl.gemm (%arg0: tensor<32x64xf32>, %arg1: tensor<64x32xf32>,
                          %arg2: tensor<32x32xf32>) -> tensor<32x32xf32>
  return %0 : tensor<32x32xf32>
}
...
// CHECK-LABEL: func.func @astl_mixed
// CHECK-SAME:  %[[ARG0:.+]]: memref<32x64xf32>, %[[ARG1:.+]]: memref<64x32xf32>,
// CHECK-SAME:  %[[ARG2:.+]]: memref<32x32xf32>, %[[ARG3:.+]]: memref<32x32xf32>
func.func @astl_mixed(%arg0: tensor<32x64xf32>, %arg1: tensor<64x32xf32>,
  ...
  // CHECK: astl.gemm ins(%[[ARG0]] : memref<32x64xf32>, %[[ARG1]] : memref<64x32xf32>, %[[ARG2]] : memref<32x32xf32>) 
  // CHECK-SAME:       outs(%[[ARG2]] : memref<32x32xf32>)
  %1 = astl.add (%0: tensor<32x32xf32>, %arg3: tensor<32x32xf32>) -> tensor<32x32xf32>
  // CHECK-NEXT: astl.add ins(%[[ARG2]] : memref<32x32xf32>, %[[ARG3]] : memref<32x32xf32>) 
  // CHECK-SAME:         outs(%[[ARG3]] : memref<32x32xf32>)
  %2 = astl.relu (%1: tensor<32x32xf32>) -> tensor<32x32xf32>
  // CHECK-NEXT: astl.relu ins(%[[ARG3]] : memref<32x32xf32>) 
  // CHECK-SAME:          outs(%[[ARG3]] : memref<32x32xf32>)
...
// CHECK-LABEL: func.func @astl_tensor_brgemm
// CHECK-SAME: %[[ARG0:.+]]: memref<4x32x32xf32>, %[[ARG1:.+]]: memref<4x32x32xf32>,
// CHECK-SAME: %[[ARG2:.+]]: memref<32x32xf32>  
func.func @astl_tensor_brgemm(%arg0: tensor<4x32x32xf32>, %arg1: tensor<4x32x32xf32>, 
                             %arg2: tensor<32x32xf32>) -> tensor<32x32xf32> {
  %0 = astl.brgemm (%arg0: tensor<4x32x32xf32>, %arg1: tensor<4x32x32xf32>,
                          %arg2: tensor<32x32xf32>) -> tensor<32x32xf32>
  // CHECK: astl.brgemm ins(%[[ARG0]] : memref<4x32x32xf32>, %[[ARG1]] : memref<4x32x32xf32>, %[[ARG2]] : memref<32x32xf32>) 
  // CHECK-SAME:       outs(%[[ARG2]] : memref<32x32xf32>)
  return %0 : tensor<32x32xf32>
}
...
// CHECK-LABEL: func.func @astl_add_with_insert_slice
// CHECK-SAME: %[[ARG0:.+]]: memref<1536xbf16>, %[[ARG1:.+]]: memref<8x48x32x32xbf16>
func.func @astl_add_with_insert_slice(%arg0: tensor<1536xbf16>, 
  ...
  %0 = scf.forall (%arg2, %arg3) in (%c8, %c48) shared_outs(%arg4 = %arg1) -> (tensor<8x48x32x32xbf16>) {
    ...
    %1 = astl.add(%extracted_slice_0 : tensor<32x32xbf16>, %extracted_slice : tensor<32xbf16>) -> tensor<32x32xbf16>
...
// CHECK-NEXT: astl.add ins(%[[SUB0]] : memref<32x32xbf16, strided<[32, 1], offset: ?>>, 
...
func.func @sequence_of_adds_on_rhs(%arg0: tensor<3x3xf32>, %arg1: tensor<3x3xf32>) -> tensor<3x3xf32> {
  %0 = astl.add (%arg0: tensor<3x3xf32>, %arg1: tensor<3x3xf32>) -> tensor<3x3xf32>
  %1 = astl.add (%0: tensor<3x3xf32>, %arg1: tensor<3x3xf32>) -> tensor<3x3xf32>
...
// CHECK: astl.add ins(%[[ARG0]] : memref<3x3xf32>, %[[ALLOC]] : memref<3x3xf32>) 
// CHECK-SAME:    outs(%[[ALLOC]] : memref<3x3xf32>)
// CHECK: astl.add ins(%[[ALLOC]] : memref<3x3xf32>, %[[ARG1]] : memref<3x3xf32>) 
...
func.func @sequence_of_adds_on_lhs(%arg0: tensor<3x3xf32>, %arg1: tensor<3x3xf32>) -> tensor<3x3xf32> {
  %0 = astl.add (%arg0: tensor<3x3xf32>, %arg1: tensor<3x3xf32>) -> tensor<3x3xf32>
  %1 = astl.add (%0: tensor<3x3xf32>, %arg0: tensor<3x3xf32>) -> tensor<3x3xf32>
  return %1 : tensor<3x3xf32>
}
...
// CHECK-NOT: memref.alloc
// CHECK-SAME:  %[[ARG0:.+]]: memref<3x3xf32>, %[[ARG1:.+]]: memref<3x3xf32>
// CHECK: astl.add ins(%[[ARG0]] : memref<3x3xf32>, %[[ARG1]] : memref<3x3xf32>) 
// CHECK-SAME:    outs(%[[ARG1]] : memref<3x3xf32>)
// CHECK: astl.add ins(%[[ARG1]] : memref<3x3xf32>, %[[ARG0]] : memref<3x3xf32>) 
// CHECK-SAME:    outs(%[[ARG0]] : memref<3x3xf32>)

// -----

#map = affine_map<(d0, d1) -> (d0, d1)>
func.func @astl_and_linalg(%arg0: tensor<3x3xf32>, %arg1: tensor<3x3xf32>) -> tensor<3x3xf32> {
  %0 = astl.add (%arg0: tensor<3x3xf32>, %arg1: tensor<3x3xf32>) -> tensor<3x3xf32>
  %1 = linalg.generic {
...
// CHECK-LABEL: func.func @astl_and_linalg
// CHECK-SAME: %[[ARG0:.+]]: memref<3x3xf32>, %[[ARG1:.+]]: memref<3x3xf32>
// CHECK: astl.add ins(%[[ARG0:.+]] : memref<3x3xf32>, %[[ARG1:.+]] : memref<3x3xf32>) outs(%[[ARG1:.+]] : memref<3x3xf32>)
...
// Here you need the alloc. astl.add second operand reads from 'the old value' of %arg1.
...
func.func @test_mlp_bf16_3_layer_1024(%arg0: tensor<256x1024xbf16>, 
  ...
  %0 = astl.gemm (%arg0: tensor<256x1024xbf16>, %cst: tensor<1024x1024xbf16>, 
                   %arg1: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
  %1 = astl.add (%0: tensor<256x1024xbf16>, %arg1: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
  %2 = astl.relu (%1: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
...
// CHECK-NEXT: astl.gemm ins(%[[ARG0]] : memref<256x1024xbf16>, %[[CST]] : memref<1024x1024xbf16>, %[[ALLOC]] : memref<256x1024xbf16>) outs(%[[ALLOC]] : memref<256x1024xbf16>)
// CHECK-NEXT: astl.add ins(%[[ALLOC]] : memref<256x1024xbf16>, %[[ARG1]] : memref<256x1024xbf16>) outs(%[[ARG1]] : memref<256x1024xbf16>)
// CHECK-NEXT: astl.relu ins(%[[ARG1]] : memref<256x1024xbf16>) outs(%[[ARG1]] : memref<256x1024xbf16>)
...
func.func @test_mlp_bf16_1_layer_1024(%arg0: tensor<256x1024xbf16>, 
  ...
  %0 = astl.gemm (%arg0: tensor<256x1024xbf16>, %cst: tensor<1024x1024xbf16>, 
                   %arg1: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
  %1 = astl.add (%cst1: tensor<256x1024xbf16>, %0: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
  %2 = astl.relu (%1: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
  return %2 : tensor<256x1024xbf16>
}
...
func.func @test_mlp_bf16_1_layer_1024(%arg0: tensor<256x1024xbf16>, 
  ...
  %0 = astl.gemm (%arg0: tensor<256x1024xbf16>, %cst: tensor<1024x1024xbf16>, 
                   %arg1: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
  %1 = astl.add (%0: tensor<256x1024xbf16>, %cst1: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
  %2 = astl.relu (%1: tensor<256x1024xbf16>) -> tensor<256x1024xbf16>
  return %2 : tensor<256x1024xbf16>
}
...
func.func @test_zero(%arg0: tensor<5x5xf32>) -> tensor<5x5xf32> {
  ...
  %0 = astl.zero (%arg0: tensor<5x5xf32>) -> tensor<5x5xf32>
...
func.func @brgemm_in_loops(%arg0: tensor<4x16x32x32xf32>, %arg1: tensor<8x16x32x32xf32>, %arg2: tensor<4x8x32x32xf32>) -> tensor<4x8x32x32xf32> {
  ...
  %0 = scf.for %arg3 = %c0 to %c4 step %c1 iter_args(%arg4 = %arg2) -> (tensor<4x8x32x32xf32>) {
    %1 = scf.for %arg5 = %c0 to %c8 step %c1 iter_args(%arg6 = %arg4) -> (tensor<4x8x32x32xf32>) {
      ...
      %2 = astl.brgemm (%extracted_slice : tensor<16x32x32xf32>, %extracted_slice_0 : tensor<16x32x32xf32>, %extracted_slice_1 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
...
// CHECK: astl.brgemm ins(%{{.+}} : memref<16x32x32xf32, strided<[1024, 32, 1], offset: ?>>, %{{.+}} : memref<16x32x32xf32, strided<[1024, 32, 1], offset: ?>>, %{{.+}} : memref<32x32xf32, strided<[32, 1], offset: ?>>) outs(%{{.+}} : memref<32x32xf32, strided<[32, 1], offset: ?>>)
...
func.func @mlp_single_layer(%arg0: tensor<256x1024xf32>) -> tensor<256x1024xf32> {
  ...
  %2 = scf.forall (%arg1, %arg2) = (%c0, %c0) to (%c256, %c1024) step (%c32, %c32) shared_outs(%arg3 = %1) -> (tensor<256x1024xf32>) {
    ...
    %3 = astl.gemm (%extracted_slice : tensor<32x1024xf32>, %cst_1 : tensor<1024x32xf32>, %extracted_slice_4 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    %4 = astl.add (%3 : tensor<32x32xf32>, %cst : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    %5 = astl.relu (%4 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    scf.forall.in_parallel {
...
// CHECK: astl.gemm ins(%[[SUBVIEW]] : memref<32x1024xf32, strided<[1024, 1], offset: ?>>, %[[GLOBAL]] : memref<1024x32xf32>, %subview_0 : memref<32x32xf32, strided<[1024, 1], offset: ?>>) 
// CHECK-SAME:  outs(%[[SUBVIEW0]] : memref<32x32xf32, strided<[1024, 1], offset: ?>>)
// CHECK: astl.add ins(%[[SUBVIEW0]] : memref<32x32xf32, strided<[1024, 1], offset: ?>>, %[[GLOBAL1]] : memref<32x32xf32>) 
// CHECK-SAME:  outs(%[[SUBVIEW0]] : memref<32x32xf32, strided<[1024, 1], offset: ?>>)
// CHECK: astl.relu ins(%[[SUBVIEW0]] : memref<32x32xf32, strided<[1024, 1], offset: ?>>) 
// CHECK-SAME:  outs(%[[SUBVIEW0]] : memref<32x32xf32, strided<[1024, 1], offset: ?>>)
...
func.func @splitted_init(%arg0: tensor<256x1024xf32>) -> tensor<256x1024xf32> {
  ...
  %c32 = arith.constant 32 : index
  %0 = tensor.empty() : tensor<256x1024xf32>
  %1 = astl.zero (%0 : tensor<256x1024xf32>) -> (tensor<256x1024xf32>)
  %2 = scf.forall (%arg1, %arg2) = (%c0, %c0) to (%c256, %c1024) step (%c32, %c32) shared_outs(%arg3 = %1) -> (tensor<256x1024xf32>) {
    %extracted_slice = tensor.extract_slice %arg0[%arg1, 0] [32, 1024] [1, 1] : tensor<256x1024xf32> to tensor<32x1024xf32>
    %extracted_slice_3 = tensor.extract_slice %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<256x1024xf32> to tensor<32x32xf32>
    %9 = astl.gemm (%extracted_slice : tensor<32x1024xf32>, %cst_1 : tensor<1024x32xf32>, %extracted_slice_3 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    %extracted_slice_4 = tensor.extract_slice %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<256x1024xf32> to tensor<32x32xf32>
    %10 = astl.add (%9 : tensor<32x32xf32>, %cst : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    %extracted_slice_5 = tensor.extract_slice %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<256x1024xf32> to tensor<32x32xf32>
    %11 = astl.relu (%10 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    scf.forall.in_parallel {
  ...
  %4 = astl.zero (%3 : tensor<256x1024xf32>) -> (tensor<256x1024xf32>)
  %5 = scf.forall (%arg1, %arg2) = (%c0, %c0) to (%c256, %c1024) step (%c32, %c32) shared_outs(%arg3 = %4) -> (tensor<256x1024xf32>) {
    ...
    %9 = astl.gemm (%extracted_slice : tensor<32x1024xf32>, %cst_1 : tensor<1024x32xf32>, %extracted_slice_3 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    %extracted_slice_4 = tensor.extract_slice %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<256x1024xf32> to tensor<32x32xf32>
    %10 = astl.add (%9 : tensor<32x32xf32>, %cst_0 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    %extracted_slice_5 = tensor.extract_slice %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<256x1024xf32> to tensor<32x32xf32>
    %11 = astl.relu (%10 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    scf.forall.in_parallel {
      tensor.parallel_insert_slice %11 into %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<32x32xf32> into tensor<256x1024xf32>
  ...
  %7 = astl.zero (%6 : tensor<256x1024xf32>) -> (tensor<256x1024xf32>)
  %8 = scf.forall (%arg1, %arg2) = (%c0, %c0) to (%c256, %c1024) step (%c32, %c32) shared_outs(%arg3 = %7) -> (tensor<256x1024xf32>) {
    ...
    %9 = astl.gemm (%extracted_slice : tensor<32x1024xf32>, %cst_1 : tensor<1024x32xf32>, %extracted_slice_3 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    %extracted_slice_4 = tensor.extract_slice %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<256x1024xf32> to tensor<32x32xf32>
    %10 = astl.add (%9 : tensor<32x32xf32>, %cst_2 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    %extracted_slice_5 = tensor.extract_slice %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<256x1024xf32> to tensor<32x32xf32>
    %11 = astl.relu (%10 : tensor<32x32xf32>) -> (tensor<32x32xf32>)
    scf.forall.in_parallel {
      tensor.parallel_insert_slice %11 into %arg3[%arg1, %arg2] [32, 32] [1, 1] : tensor<32x32xf32> into tensor<256x1024xf32>
...
func.func @alloc_must_escape(%arg0: tensor<256x1024xf32>) -> tensor<256x1024xf32> {
  ...
  %0 = tensor.empty() : tensor<256x1024xf32>
  // astl.zero bufferize on %0
  %1 = astl.zero (%0 : tensor<256x1024xf32>) -> (tensor<256x1024xf32>)
  // astl.gemm bufferize on %1 (alias %0)
  %2 = astl.gemm (%arg0 : tensor<256x1024xf32>, %cst : tensor<1024x1024xf32>, %1 : tensor<256x1024xf32>) -> (tensor<256x1024xf32>)
  // astl.add bufferize on the lhs (%2 alias %0), since the rhs is constant.
  %3 = astl.add (%2 : tensor<256x1024xf32>, %cst_0 : tensor<256x1024xf32>) -> (tensor<256x1024xf32>)
  // astl.relu bufferize on %3 alias %0
  %4 = astl.relu (%3 : tensor<256x1024xf32>) -> (tensor<256x1024xf32>) 
...
func.func @add_in_place(%arg0: tensor<3x3xf32>) -> tensor<3x3xf32> {
  %0 = astl.add(%arg0: tensor<3x3xf32>, %arg0: tensor<3x3xf32>) -> tensor<3x3xf32>
  %1 = astl.add(%0: tensor<3x3xf32>, %0: tensor<3x3xf32>) -> tensor<3x3xf32>
  return %1 : tensor<3x3xf32>
}

// CHECK-LABEL: add_in_place
// CHECK-SAME: %[[ARG0:.+]]: memref<3x3xf32>
// CHECK: astl.add ins(%[[ARG0]] : memref<3x3xf32>, %[[ARG0]] : memref<3x3xf32>) outs(%[[ARG0]] : memref<3x3xf32>)
// CHECK-NEXT: astl.add ins(%[[ARG0]] : memref<3x3xf32>, %[[ARG0]] : memref<3x3xf32>) outs(%[[ARG0]] : memref<3x3xf32>)

// -----

func.func @add_in_place_cst() -> tensor<3x3xf32> {
  %cst = arith.constant dense<0.0> : tensor<3x3xf32>
  %0 = astl.add(%cst: tensor<3x3xf32>, %cst: tensor<3x3xf32>) -> tensor<3x3xf32>
...
// CHECK-NEXT: astl.add ins(%[[GB]] : memref<3x3xf32>, %[[GB]] : memref<3x3xf32>) 
// CHECK-SAME:  outs(%[[ALLOC]] : memref<3x3xf32>)
...
func.func @add_in_place_mixed(%arg0: tensor<4x3xf32>, %arg1: tensor<3x4xf32>) -> tensor<4x4xf32> {
  ...
  %0 = astl.gemm (%arg0: tensor<4x3xf32>, %arg1: tensor<3x4xf32>, %empty: tensor<4x4xf32>) -> tensor<4x4xf32>
  %1 = astl.add (%0: tensor<4x4xf32>, %0: tensor<4x4xf32>) -> tensor<4x4xf32>
...
// CHECK-NEXT: astl.gemm ins(%[[ARG0]] : memref<4x3xf32>, %[[ARG1]] : memref<3x4xf32>, %[[ALLOC]] : memref<4x4xf32>) 
// CHECK-SAME:  outs(%[[ALLOC]] : memref<4x4xf32>)
// CHECK-NEXT: astl.add ins(%[[ALLOC]] : memref<4x4xf32>, %[[ALLOC]] : memref<4x4xf32>) outs(%[[ALLOC]] : memref<4x4xf32>)
// CHECK-NEXT: return %[[ALLOC]] : memref<4x4xf32>

// -----

func.func @scalar_add(%arg0: tensor<3x3xf32>, %arg1: f32) -> tensor<3x3xf32> {
  %0 = astl.add(%arg0: tensor<3x3xf32>, %arg1: f32) -> tensor<3x3xf32>
  return %0 : tensor<3x3xf32>
}

// CHECK-LABEL: scalar_add
// CHECK-SAME: %[[ARG0:.+]]: memref<3x3xf32>, %[[ARG1:.+]]: f32
// CHECK: astl.add ins(%[[ARG0]] : memref<3x3xf32>, %[[ARG1]] : f32) outs(%[[ARG0]] : memref<3x3xf32>)
...
func.func @add_out_of_place(%arg0: tensor<1x3xf32>, %arg1: f32) -> tensor<3x3xf32> {
  ...
  %0 = astl.add(%arg0: tensor<1x3xf32>, %arg1: f32) -> tensor<3x3xf32>
  return %0: tensor<3x3xf32>
}
...
func.func @fused_brgemm_op(%arg0: tensor<1x3x3xf32>, %arg1: tensor<1x3x3xf32>, 
  ...
  // CHECK: astl.fused_brgemm [unary = relu, binary = add] 
...
func.func @allocation_should_not_escape_unary(
  ...
  // CHECK: memref.alloc
  %0 = astl.identity (%arg1 : tensor<10xf32>) -> (tensor<10x10xf32>)
  %1 = linalg.generic {
    indexing_maps = [#map, #map, #map], 
    iterator_types = ["parallel", "parallel"]} 
...
func.func @allocation_should_not_escape_unary(
    %arg0: tensor<10x10xf32>, %arg1: tensor<10xf32>, %arg2: tensor<10x10xf32>) -> tensor<10x10xf32> {
  // CHECK: memref.alloc
  %0 = astl.relu (%arg1 : tensor<10xf32>) -> (tensor<10x10xf32>)
  %1 = linalg.generic {
    indexing_maps = [#map, #map, #map], 
    iterator_types = ["parallel", "parallel"]} 
    ins(%arg0, %0 : tensor<10x10xf32>, tensor<10x10xf32>) 
...
func.func @allocation_should_not_escape_unary(
  ...
  // CHECK-NOT: memref.alloc
  %0 = astl.zero (%arg1 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  %1 = linalg.generic {
    indexing_maps = [#map, #map, #map], 
    iterator_types = ["parallel", "parallel"]} 
    ins(%arg0, %0 : tensor<10x10xf32>, tensor<10x10xf32>) 
...
func.func @allocation_should_not_escape_binary(
    %arg0: tensor<10x10xf32>, %arg1: tensor<10xf32>, %arg2: tensor<10x10xf32>) -> tensor<10x10xf32> {
  // CHECK: memref.alloc
  %0 = astl.add (%arg1 : tensor<10xf32>, %arg1 : tensor<10xf32>) -> (tensor<10x10xf32>)
  %1 = linalg.generic {
    indexing_maps = [#map, #map, #map], 
    iterator_types = ["parallel", "parallel"]} 
    ins(%arg0, %0 : tensor<10x10xf32>, tensor<10x10xf32>) 
...
// CHECK-NEXT: astl.add ins(%[[ARG0]] : memref<3x3xf32>, %[[ALLOC]] : memref<3x3xf32>) outs(%[[ALLOC]] : memref<3x3xf32>)
// CHECK-NEXT: astl.add ins(%[[ALLOC]] : memref<3x3xf32>, %[[ARG0]] : memref<3x3xf32>) outs(%[[ARG0]] : memref<3x3xf32>)
...
func.func @conflicting_in_place(%arg0: tensor<3x3xf32>) -> tensor<3x3xf32> {
  %0 = astl.add(%arg0: tensor<3x3xf32>, %arg0: tensor<3x3xf32>) -> tensor<3x3xf32>
  %1 = astl.add(%arg0: tensor<3x3xf32>, %0: tensor<3x3xf32>) -> tensor<3x3xf32>
  return %1 : tensor<3x3xf32>
}
...
func.func @gemm_back_to_back(%arg0: tensor<10x10xf32>) -> tensor<10x10xf32> {
  ...
  %1 = astl.zero (%0 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  %2 = astl.gemm (%arg0 : tensor<10x10xf32>, %cst_0 : tensor<10x10xf32>, %1 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  %3 = astl.gemm (%2 : tensor<10x10xf32>, %cst_1 : tensor<10x10xf32>, %1 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
...
// CHECK: %[[ALLOC:.+]] = memref.alloc() {{.+}} : memref<10x10xf32>
// CHECK: astl.zero ins(%[[ALLOC]] : memref<10x10xf32>) outs(%[[ALLOC]] : memref<10x10xf32>)
// CHECK: %[[ALLOC_1:.+]] = memref.alloc() {{.+}} : memref<10x10xf32>
// CHECK: memref.copy %[[ALLOC]], %[[ALLOC_1]] : memref<10x10xf32> to memref<10x10xf32>
// CHECK: astl.gemm ins(%[[ARG0]] : memref<10x10xf32>, %{{.+}} : memref<10x10xf32>, %[[ALLOC_1]] : memref<10x10xf32>) outs(%[[ALLOC_1]] : memref<10x10xf32>)
// CHECK: astl.gemm ins(%[[ALLOC_1]] : memref<10x10xf32>, %{{.+}} : memref<10x10xf32>, %[[ALLOC]] : memref<10x10xf32>) outs(%[[ALLOC]] : memref<10x10xf32>)
...
func.func @gemm_back_to_back(%arg0: tensor<10x10xf32>, %arg1: tensor<10x10xf32>,
  ...
  %0 = tensor.empty() : tensor<10x10xf32>
  %1 = astl.zero (%0 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  %2 = astl.gemm (%arg0 : tensor<10x10xf32>, %arg1 : tensor<10x10xf32>, %1 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  %3 = astl.gemm (%2 : tensor<10x10xf32>, %arg2 : tensor<10x10xf32>, %1 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  return %3 : tensor<10x10xf32>
}
...
// CHECK: %[[ALLOC_1:.+]] = memref.alloc() {{.+}} : memref<10x10xf32>
// CHECK: memref.copy %[[ALLOC]], %[[ALLOC_1]] : memref<10x10xf32> to memref<10x10xf32>
// CHECK: astl.gemm ins(%[[ARG0]] : memref<10x10xf32>, %[[ARG1]] : memref<10x10xf32>, %[[ALLOC_1]] : memref<10x10xf32>) outs(%[[ALLOC_1]] : memref<10x10xf32>)
// CHECK: astl.gemm ins(%[[ALLOC_1]] : memref<10x10xf32>, %[[ARG2]] : memref<10x10xf32>, %[[ALLOC]] : memref<10x10xf32>) outs(%[[ALLOC]] : memref<10x10xf32>)
...
func.func @gemm_back_to_back(%arg0: tensor<10x10xf32>, %arg1: tensor<10x10xf32>,
  ...
  %2 = astl.gemm (%arg0 : tensor<10x10xf32>, %arg1 : tensor<10x10xf32>, %arg3 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  %3 = astl.gemm (%2 : tensor<10x10xf32>, %arg2 : tensor<10x10xf32>, %arg3 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  return %3 : tensor<10x10xf32>
}
...
// CHECK: astl.gemm ins(%[[ARG0]] : memref<10x10xf32>, %[[ARG1]] : memref<10x10xf32>, %[[ALLOC]] : memref<10x10xf32>) outs(%[[ALLOC]] : memref<10x10xf32>)
// CHECK: astl.gemm ins(%[[ALLOC]] : memref<10x10xf32>, %[[ARG2]] : memref<10x10xf32>, %[[ARG3]] : memref<10x10xf32>) outs(%[[ARG3]] : memref<10x10xf32>)
...
func.func @gemm_back_to_back(%arg0: tensor<10x10xf32>, %arg1: tensor<10x10xf32>,
  ...
  %2 = astl.gemm (%arg0 : tensor<10x10xf32>, %arg1 : tensor<10x10xf32>, %arg3 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  %3 = astl.gemm (%2 : tensor<10x10xf32>, %arg2 : tensor<10x10xf32>, %arg4 : tensor<10x10xf32>) -> (tensor<10x10xf32>)
  return %3 : tensor<10x10xf32>
}
...
// CHECK-NOT: memref.alloc
// CHECK-NOT: memref.copy
// CHECK: astl.gemm ins(%[[ARG0]] : memref<10x10xf32>, %[[ARG1]] : memref<10x10xf32>, %[[ARG3]] : memref<10x10xf32>) outs(%[[ARG3]] : memref<10x10xf32>)
// CHECK: astl.gemm ins(%[[ARG3]] : memref<10x10xf32>, %[[ARG2]] : memref<10x10xf32>, %[[ARG4]] : memref<10x10xf32>) outs(%[[ARG4]] : memref<10x10xf32>)
...
func.func @gemms(%arg0: tensor<10x10xf32>, %arg1: tensor<10x10xf32>,
  ...
  %1 = astl.zero (%0: tensor<10x10xf32>) -> tensor<10x10xf32>
  %2 = astl.gemm (%arg0: tensor<10x10xf32>, %arg1: tensor<10x10xf32>, %1: tensor<10x10xf32>) -> tensor<10x10xf32>
  %3 = astl.gemm (%arg2: tensor<10x10xf32>, %arg3: tensor<10x10xf32>, %1: tensor<10x10xf32>) -> tensor<10x10xf32>
...
// CHECK: memref.copy %[[ALLOC]], %[[ALLOC_1]] : memref<10x10xf32> to memref<10x10xf32>
// CHECK: astl.gemm ins(%[[ARG0]] : memref<10x10xf32>, %[[ARG1]] : memref<10x10xf32>, %[[ALLOC_1]] : memref<10x10xf32>) outs(%[[ALLOC_1]] : memref<10x10xf32>)
// CHECK: astl.gemm ins(%[[ARG2]] : memref<10x10xf32>, %[[ARG3]] : memref<10x10xf32>, %[[ALLOC]] : memref<10x10xf32>) outs(%[[ALLOC]] : memref<10x10xf32>)
...
func.func @not_same_repetitive_region_rhs(%arg0: tensor<10x10xf32>) -> tensor<10x10xf32> {
  ...
  %2 = scf.for %arg1 = %c0 to %c2 step %c1 iter_args(%arg2 = %arg0) -> tensor<10x10xf32> {
    %3 = astl.add (%arg2: tensor<10x10xf32>, %1: tensor<10x10xf32>) -> tensor<10x10xf32>
...
// CHECK: astl.add ins(%[[ARG0]] : memref<10x10xf32>, %[[ALLOC]] : memref<10x10xf32>) 
...
func.func @not_same_repetitive_region_lhs(%arg0: tensor<10x10xf32>) -> tensor<10x10xf32> {
  ...
  %1 = linalg.fill ins(%cst : f32) outs(%0 : tensor<10x10xf32>) -> tensor<10x10xf32>
  %2 = scf.for %arg1 = %c0 to %c2 step %c1 iter_args(%arg2 = %arg0) -> tensor<10x10xf32> {
    %3 = astl.add (%1: tensor<10x10xf32>, %arg2: tensor<10x10xf32>) -> tensor<10x10xf32>
    scf.yield %3 : tensor<10x10xf32>
  }
  return %2 : tensor<10x10xf32>
}
...
// CHECK: linalg.fill ins(%[[CST]] : f32) outs(%[[ALLOC]] : memref<10x10xf32>)
// CHECK: scf.for %{{.+}} = %[[C0]] to %[[C2]] step %[[C1]]
// CHECK: astl.add ins(%[[ALLOC]] : memref<10x10xf32>, %[[ARG0]] : memref<10x10xf32>)
// CHECK-SAME:    outs(%[[ARG0]] : memref<10x10xf32>)
...
// CHECK: scf.for %{{.+}} = %[[C0]] to %[[C2]] step %[[C1]]
// CHECK: astl.add ins(%[[ALLOC]] : memref<10x10xf32>, %[[ALLOC_0]] : memref<10x10xf32>) 
...
func.func @not_same_repetitive_region_both(%arg0: tensor<10x10xf32>) -> tensor<10x10xf32> {
  ...
  %2 = scf.for %arg1 = %c0 to %c2 step %c1 iter_args(%arg2 = %arg0) -> tensor<10x10xf32> {
    // CHECK: %[[ALLOC:.+]] = memref.alloc() {alignment = 64 : i64} : memref<10x10xf32>
    %3 = astl.add (%1: tensor<10x10xf32>, %1: tensor<10x10xf32>) -> tensor<10x10xf32>
    // CHECK-NEXT: astl.add ins(%[[OUTER_ALLOC]] : memref<10x10xf32>, %[[OUTER_ALLOC]] : memref<10x10xf32>) 
    // CHECK-SAME:         outs(%[[ALLOC]] : memref<10x10xf32>)
    %4 = astl.add (%3: tensor<10x10xf32>, %arg2: tensor<10x10xf32>) -> tensor<10x10xf32>
    // CHECK: astl.add ins(%[[ALLOC]] : memref<10x10xf32>, %[[ARG0]] : memref<10x10xf32>) 
    // CHECK-SAME:    outs(%[[ARG0]] : memref<10x10xf32>)
