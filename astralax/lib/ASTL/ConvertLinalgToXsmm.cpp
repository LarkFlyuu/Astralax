...
void ConvertLinalgToXsmm::runOnOperation() {
  ...
  astl::populateLinalgToXsmmPatterns(patterns);
...
void mlir::astl::populateLinalgToXsmmPatterns(RewritePatternSet &patterns) {
  patterns
...
mlir::astl::createConvertLinalgToXsmmPass() {
