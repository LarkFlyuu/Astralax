...
#ifndef ASTL_TRANSFORMS_H
#define ASTL_TRANSFORMS_H
...
FailureOr<astl::BrgemmOp> packVNNIBRGemmOp(RewriterBase &rewriter,
...
namespace astl {
void populateConvertLinalgToAstlPatterns(RewritePatternSet &patterns);
void populateMapLinalgToAstlPatterns(RewritePatternSet &patterns);
void populateAstlToXsmmPatterns(RewritePatternSet &patterns);
...
void populateAstlDeGeneralizationPatterns(RewritePatternSet &patterns);
